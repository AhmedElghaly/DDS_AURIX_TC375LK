...
UCDRDLLAPI bool ucdr_deserialize_string(ucdrBuffer* mb, char* string, const uint32 string_capacity);

UCDRDLLAPI bool ucdr_serialize_endian_string(ucdrBuffer* mb, ucdrEndianness endianness, const char* string);
UCDRDLLAPI bool ucdr_deserialize_endian_string(ucdrBuffer* mb, ucdrEndianness endianness, char* string, const uint32 string_capacity);
